...
public class SwiftSimplePing: NSObject {
    ...
    private func updateStatistics() {
        statistics = PingStatistics(sent: packetsSent, received: packetsReceived, latencies: latencies)
...
extension SwiftSimplePing: SimplePingDelegate {
    ...
    public func simplePing(_ pinger: SimplePing, didStartWithAddress address: Data) {
        NSLog("SwiftSimplePing: Started pinging %@", 
    ...
    public func simplePing(_ pinger: SimplePing, didFailWithError error: Error) {
        NSLog("SwiftSimplePing: Failed with error: %@", 
    ...
    public func simplePing(_ pinger: SimplePing, didFailToSendPacket packet: Data, sequenceNumber: UInt16, error: Error) {
        NSLog("SwiftSimplePing: #%u send failed: %@", sequenceNumber, 
              shortErrorFromError(error: error as NSError))
